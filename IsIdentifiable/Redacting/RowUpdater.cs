...
public class RowUpdater : OutBase
{
    ...
    public void Update(DiscoveredServer server, Failure failure, IRegexRule usingRule)
    {
    ...
    public bool OnLoad(DiscoveredServer server, Failure failure, out IRegexRule rule)
    {
